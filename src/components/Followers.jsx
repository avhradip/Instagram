...
function Followers({ id }) {
    ...
    const [followFunloading, setFollowFunLoading] = useState(false);
    const { followers, user, buttonloading, loading } = useSelector((state) => state?.user)
                                    ...
                                    <div className='flex items-center gap-2 '>
                                        ...
                                        <div>
                                            <div className='flex items-center gap-2'>
                                                ...
                                                {user?._id !== item?._id && !item.followers?.includes(user._id) && (
                                                    <button
                                                        onClick={() => followFun({ id: user._id, followerId: item._id })}
                                                        disabled={followFunloading}
